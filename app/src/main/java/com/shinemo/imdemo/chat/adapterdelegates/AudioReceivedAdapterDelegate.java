...
public class AudioReceivedAdapterDelegate extends BaseReceivedAdapterDelegate {

    private LayoutInflater inflater;

    public AudioReceivedAdapterDelegate(Activity activity) {
        super(activity);
    ...
    protected RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        return new ViewHolder(inflater.inflate(R.layout.chat_received_audio, parent, false));
    }
    ...
    static class ViewHolder extends BaseReceivedViewHolder {
        ...
        ViewHolder(View view) {
            ...
            dot = view.findViewById(R.id.chat_audio_dot);
        }
    }
}
