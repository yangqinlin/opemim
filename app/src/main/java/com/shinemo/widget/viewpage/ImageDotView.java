package com.shinemo.widget.viewpage;
...
//		mPaint = new Paint();
//		mHeight = (int) (getResources().getDisplayMetrics().density*2);
//		mPaint.setStrokeWidth(mHeight);
    ...
    public void setmNormalBitmap(int resId) {
        mNormalBitmap = BitmapFactory.decodeResource(getResources(), resId);
    }
