package com.shinemo.widget.switchbutton;
...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setmThumbExpandTop(ta.getDimensionPixelSize(R.styleable.SwitchButton_thumb_expandTop,mConf.getThumbExpandTop()));
	...
	private void setupSafeZone() {
		...
		if (w > 0 && h > 0) {
			...
			top = getPaddingTop() + (mConf.getThumbMarginTop() > 0 ? mConf.getThumbMarginTop() : 0) - mConf.getThumbExpandTop();
