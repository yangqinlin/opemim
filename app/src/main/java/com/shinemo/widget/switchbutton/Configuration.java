...
public class Configuration implements Cloneable {
	...
	public void setmThumbExpandTop(int expandTop){
		this.mThumbExpandTop = expandTop;
	}
	...
	public int getThumbExpandTop(){
		return mThumbExpandTop;
	}
